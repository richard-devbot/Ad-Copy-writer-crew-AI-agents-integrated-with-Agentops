...
@agentops.track_agent(name='MarketingAnalysisAgents')
class MarketingAnalysisAgents:
    ...
    #@track_agent(name="product_competitor_agent")
    ...
    #@track_agent(name="strategy_planner_agent")
    ...
    #@track_agent(name="creative_content_creator_agent")
    ...
    #@track_agent(name="senior_photographer_agent")
    ...
    #@track_agent(name="chief_creative_diretor_agent")
